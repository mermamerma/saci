<?
    ...
    $xajax->registerFunction('mostrar_misiones');
    $xajax->registerFunction('mostrar_servicios');
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		document.frminforme.submit();
            ...
            {                
                xajax_mostrar_misiones(idsolicitante);
                xajax_mostrar_servicios(idsolicitante);
    ...
    <?
        ...
        if (isset($_REQUEST["accion"]) && $_REQUEST["accion"]=="guardar")
        {
            ...
            $nsolic_act=$csolic->Update_Solic_Benef_Caso();
            ...
            if ($_REQUEST["idinforme"]>0)
            {
                ...
                $ninforme=$csolic->update_Informe_Social();
            ...
            {
                $ninforme=$csolic->insertar_Informe_Social();
            ...
            if ($ninforme>0)
            {
                if ($_REQUEST["estatus_caso"]==ESPERA_PRESUPUESTO || $_REQUEST["estatus_caso"]==ESPERA_DOCUMENTACION)
                {
        ...
        $idsolicitante=$csolic->getInt("casos", "idsolicitante", "idcaso=".$_REQUEST["idcaso"]);
        $csolic->set_idsolicitante($idsolicitante);
        $data_solic=$csolic->getData();
        ...
        if ($data_solic)
        {
            ...
            $csolic->set_idcaso_informe($_REQUEST["idcaso"]);
            $csolic->set_idsolicitante($idsolicitante);
            $data_informe=$csolic->getData_Informe_Social();
    ...
    <center>     
            ...
            <form name="frminforme" id="frminforme" method="post" action="frm_informe_social.php">
                        ...
                        <td colspan="2">
                               ...
                               <tr>
                                ...
                                <td>
                                    <select name="estatus_caso" id="estatus_caso" style="width:160px;" class="inputbox" >
                                        ...
                                        <?php
                                        echo ($dat->Cargarlista("select idmaestro, descripcion from vestatus_casos where idmaestro in (133, 134) order by descripcion", $_REQUEST["estatus_caso"]));
                                        ?>
                                        </select></td>
                            </tr>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                   <textarea name="direccion" id="direccion" rows="5" class="inputbox" onkeypress="return validar_texto(this.form,this,event,'')"  style="width:474px; height:95px; margin-bottom:10px;" <?if($_REQUEST["accion"]=="consultar"){echo"readonly='readonly'";}?>><?if(isset($_REQUEST["descripcion_caso"])){echo $_REQUEST["direccion"];}?></textarea>
                                </td>
                            ...
                            <div id="dvServicios" align="center"></div>
                                ...
                                <td colspan="3">
                                   <textarea name="area_fisico" id="area_fisico" rows="5" class="inputbox" onkeypress="return validar_texto(this.form,this,event,'')"  style="width:474px; height:95px; margin-bottom:10px;" <?if($_REQUEST["accion"]=="consultar"){echo"readonly='readonly'";}?>><?if(isset($_REQUEST["area_fisico"])){echo $_REQUEST["area_fisico"];}?></textarea>
                                </td>
                             ...
                             <tr>
                                ...
                                <td colspan="3">
                                   <textarea name="area_economica" id="area_economica" rows="5" class="inputbox" onkeypress="return validar_texto(this.form,this,event,'')"  style="width:474px; height:95px; margin-bottom:10px;" <?if($_REQUEST["accion"]=="consultar"){echo"readonly='readonly'";}?>><?if(isset($_REQUEST["area_economica"])){echo $_REQUEST["area_economica"];}?></textarea>
                                </td>
                              ...
                              <tr>
                                ...
                                <td colspan="3">
                                   <textarea name="salud" id="salud" rows="5" class="inputbox" onkeypress="return validar_texto(this.form,this,event,'')"  style="width:474px; height:95px; margin-bottom:10px;" <?if($_REQUEST["accion"]=="consultar"){echo"readonly='readonly'";}?>><?if(isset($_REQUEST["salud"])){echo $_REQUEST["salud"];}?></textarea>
                                </td>
                                ...
                                <td colspan="3">
                                   <textarea name="observacion" id="observacion" rows="5" class="inputbox" onkeypress="return validar_texto(this.form,this,event,'')"  style="width:474px; height:95px; margin-bottom:10px;" <?if($_REQUEST["accion"]=="consultar"){echo"readonly='readonly'";}?>><?if(isset($_REQUEST["observacion"])){echo $_REQUEST["observacion"];}?></textarea>
                                </td>
