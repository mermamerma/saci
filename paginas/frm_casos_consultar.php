<?
    ...
    $xajax->registerFunction('mostrar_subcategorias2');
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function getkey(e)
	{
        ...
        function mostrar_subcateg()
        {
            ...
            xajax_mostrar_subcategorias2(idtipocaso, idcategoria,idcaso);
        }
		...
		function editar()
	{
		window.document.getElementById('accion').value='editar';
            ...
            <?
				...
				if(isset($_REQUEST["accion"]))
				{
					...
					if (@$_REQUEST["accion"]=="editar" || @$_REQUEST["accion"]=="consultar")
					{
						...
						$data_caso=$ccaso->consultarCaso($_REQUEST["idcaso"]);
						@session_start();
						...
						if ($data_caso)
						{
							...
							##var_dump($data_caso->rowset["idcategoria"]);
							//$_REQUEST["categoria_caso"] = $data_caso->rowset["idcategoria"];
							$_REQUEST["categoria_caso"] = ($data_caso->rowset["idcategoria"] === NULL ) ? -1 : $data_caso->rowset["idcategoria"];
							...
							mostrar_subcategorias2($_REQUEST["tipo_caso"], $_REQUEST["categoria_caso"], $_REQUEST["idcaso"]);                   
...
<body onload="mostrar_combos('<?=$_REQUEST["idremitente"]?>')">
        ...
        <center>
            ...
            <form name="frmcaso" id="frmcaso" method="post" action="frm_casos_consultar.php">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td width="65%" class="menu_izq_titulo"><img src="../comunes/imagenes/folder_edit.png" />
                        <?
                            if ($_REQUEST["idcaso"]>0)
                            {

                                $ninforme_comite=$ccaso->Count("informe_comite_actuales", "idcaso=".$_REQUEST["idcaso"]);
                                $ninforme_social=$ccaso->Count("informe_social_actuales", "idsolicitante=".$_REQUEST["idsolicitante"]);
                                //echo $_REQUEST["idsolicitante"].'****';
                        ...
                        <? }
                            ...
                            <img src="../comunes/imagenes/report.png" onmouseover="Tip('Imprimir Punto de Cuenta')" onmouseout="UnTip()" border="0" onclick="javascript:imprimir_comite('<?=$_REQUEST["idcaso"]?>')"/>
                            <? }
                            ...
                            <?  } ?>
							<img src="../comunes/imagenes/page_edit.png" onmouseover="Tip('Editar Caso')" onmouseout="UnTip()" border="0" onclick="javascript:editar()"/>	
                           <? } ?>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <tr>
                                ...
                                <tr>
                                   <td colspan="5">
                                       <div id="dvMensaje"></div>                                   </td>
                                </tr>

                                <tr>
                                   <td colspan="5">
                                       <div align="left" id="dvsolicitante" style="margin-left: 5px;"></div>                                   </td>
                                </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                   ...
                                   <input type="checkbox" id="identico" name="identico" onmouseover="Tip('Seleccionar Sólo si los Datos del Solicitantes son Idénticos a los Datos del Beneficiario')"  onmouseout="UnTip()" <? echo $_REQUEST["identico"]; ?>  onchange="javascript:selec_instruccion(this)" value="1">                                </td>
                                <td>&nbsp;                                </td>
                                <td>&nbsp;       </td>
                            </tr>
                                ...
                                <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                    <div align="center" style="background-image: url('../comunes/imagenes/barra.png');">
                                        <strong>Datos del Beneficiario</strong>                                    </div>                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input name="telefonos_benef" type="text" class="inputbox" id="telefonos_benef" onkeypress="return validar_telefono(this.form,this,event,'')" style="width:464px;" value="<?= $_REQUEST['telefonos_benef'] ?>">                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <strong>Tipo de Beneficiario:</strong>                                </td>
                                <td>
                                ...
                                <td>
                                    <input name="email_benef" type="text" class="inputbox" id="email_benef" onBlur="ValidarObjetos('email_benef','email');" value="<?= $_REQUEST['email_benef'] ?>"></input>                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="edad" type="text" class="inputbox" id="edad" maxlength="2" value="<?= $_REQUEST['edad'] ?>">                                </td>
                            </tr>
                                ...
                                <td colspan="3">
                                    <input name="comunidad_benef" type="text" class="inputbox" id="comunidad_benef"  onkeypress="return validar_texto(this.form,this,event,'')" style="width:464px;" value="<?= $_REQUEST['comunidad_benef'] ?>">                                </td>
                            </tr>
                                ...
                                <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                    <div align="center" style="background-image: url('../comunes/imagenes/barra.png');">
                                        <strong>Datos Generales del Caso</strong>                                    </div>                                </td>
                            </tr>
                                ...
                                <strong style="font:bold xx-large; color: red;" >*</strong>                                </td>
                                <td>
                                    <strong>Instrucci&oacute;n</strong>                                </td>
                                <td>
                                    <input type="checkbox" id="instruccion" name="instruccion" value="1" <? echo $_REQUEST["instruccion"]; ?> > </input>                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <strong>Remitente:</strong>                                </td>
                                <td>
                                    <div id="capaRemitente">
                                        <select name="remitente" id="remitente" style="width:160px;" class="inputbox">
                                            <option value="0">Seleccione</option>
                                        </select>
                                        <a  href="javascript:nuevo_remitente()"><img src="../comunes/imagenes/ico_16_8.gif" onmouseover="Tip('Nuevo Remitente')" onmouseout="UnTip()" style="margin-left:5px; margin-right:5px;" width="16" height="16" border="0" /></a>                                    </div>                                </td>
                                <td>
                                    <strong>Responsable:</strong>                                </td>
                                <td>
                                    <input name="responsable" type="text" class="inputbox" id="responsable" onkeypress="return validar_texto(this.form,this,event,'')" maxlength="80" value="<?= $_REQUEST['responsable'] ?>">                                </td>
                            </tr>


                            <tr>
                                <td colspan="5">
                                    <div id="dvRemitente"></div>                                </td>
                             </tr>

                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <strong>Tipo de Caso:</strong>                                </td>
                                <td>
                                    <label>
                                    ...
                                    <strong style="font:bold xx-large; color: red;" >*</strong>                                </td>
                                <td>
                                    <strong>Categor&iacute;a del Caso:</strong>                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <tr>
                                  <td>&nbsp;</td>
                                  <td><strong> Estatus del Caso: </strong> </td>
                                  <td colspan="3">
								  <select name="estatus_caso" id="estatus_caso" style="width:160px;" class="inputbox" >
										...
										echo ($dat->Cargarlista("select idmaestro, descripcion from vestatus_casos order by descripcion", $_REQUEST["idestatus"]));
                                        ?>
                                    </select>
								  </td>
                                </tr>
                            ...
                            <tr>
                                <td colspan="5" align="center">
									...
									?>
										...
										<img src="../comunes/imagenes/page_edit.png" onmouseover="Tip('Editar Caso')" onmouseout="UnTip()" border="0" onclick="javascript:editar()"/>	
									   <? } ?>
									   <img src="../comunes/imagenes/door_in.png" onmouseover="Tip('Cerrar')" onmouseout="UnTip()" border="0" onclick="javascript:cerrar()"/>								</td>
                            </tr>
