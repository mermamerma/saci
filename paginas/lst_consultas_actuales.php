...
<form name="frmlista_casos" action="lst_consultas_actuales.php?accion=buscar" method="post">

	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
	<td width="76%" class="menu_izq_titulo">
		<img src="../comunes/imagenes/folder_star.png" />
		Casos Nuevos
	</td>
	 ...
	 <?
		...
		if (isset($_REQUEST["accion"]) && $_REQUEST["accion"]=="buscar") 
		{
                    ...
                    {
                        $filtro.=" and c.idcaso in (select idcaso from casos_categorias_nuevos where idsubcategoria=".$_REQUEST["subcategoria"].")";
