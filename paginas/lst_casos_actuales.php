...
<script language="javascript">
	...
	function  nuevo()
	{
		abrir_ventana('frm_casos_nuevos.php?accion=nuevo', 'contenido');
	}
	...
	function  editar()
	{
		...
		{
                    window.open('frm_casos_consultar.php?accion=editar&idcaso='+document.frmlista_casos.idcaso_selec.value,'contenido');
		}
		else
			alert('¡Debe Seleccionar un Caso Primero..!');
	}
	...
	function consultar()
	{
		//alert (document.frmlista_casos.idcaso_selec.value);
		if (document.frmlista_casos.idcaso_selec.value>0)
		{
                    window.open('frm_casos_consultar.php?accion=consultar&idcaso='+document.frmlista_casos.idcaso_selec.value,'contenido');
		}
		else
			alert('¡Debe Seleccionar un Caso Primero..!');
	}
...
<form name="frmlista_casos" method="post">
	...
	<img src="../comunes/imagenes/folder_bug.png" />
	Seguimiento de Casos
	 ...
	 <?
            ...
            //if ($cusuario->get_eliminar()=='1') echo "<td width=\"4%\" align=\"center\"><a href=\"javascript:eliminar()\"><img  alt=\"Eliminar Caso\" title=\"Eliminar Caso\" src=\"../comunes/imagenes/page_white_delete.png\" border=\"0\"/></a> </td>";
            ...
            <div id="dvBusqueda" style="display:none;">
             ...
             <table width="100%" border="0" class="tablaTitulo" >
                ...
                <tr>
                  ...
                  <td><select name="parroquia" id="parroquia" style="width:166px;" class="inputbox">
                    <option value="0">Seleccione...</option>
                    <?php
                  ...
                  <td><select name="estatus" id="estatus" style="width:166px;" class="inputbox">
                    <option value="0">Seleccione...</option>
                    <?php
                ...
                <tr>
                    ...
                    <td width="176"><input class="inputbox_fecha" name="f_inicio2"  id="f_inicio2"  onchange="cambio_inicio();" value="" size="10"   readonly="true" />
                ...
                <tr>
                    ...
                    <td width="199"><input name="rif_solic" type="text" class="inputbox" id="rif_solic" onkeypress="return RifFormat(this,'Rif del Solicitante Invalido',-1,true,event)" onmouseout="UnTip()" maxlength="12" value="<?= @$_REQUEST['rif_solic'] ?>" ></input>                    </td>
                </tr>
                ...
                <div align="center" style="background-image: url('../comunes/imagenes/barra.png');">
                 ...
                 <tr>
                    ...
                    <td width="89"><strong>R.I.F:</strong></td>
                    <td width="199"><input name="rif_benef" type="text" class="inputbox" id="rif_benef" onkeypress="return RifFormat(this,'Rif del Beneficiario Invalido',-1,true,event)" onmouseout="UnTip()" maxlength="12" value="<?= @$_REQUEST['rif_benef'] ?>" ></input>                    </td>
                </tr>
	...
	<?
		...
		{			
                    case "80":		//Transcriptor
                            $filtro=" where c.idestatus=61 ";
                            break;
                    default:
                            $filtro=" where c.idcaso in (select idcaso from casos_analistas_actuales where idanalista=".$cusuario->get_idusuario().") ";
                            break;
		}
