    ...
    <?php
		...
		if (isset($_POST["guardar_caso"]) && $_POST["guardar_caso"]=="Guardar") 
		{
			...
			else
			{
				...
				{
					echo "<script language='JavaScript'> 
							alert('¡Error al Intentar Registrar el Caso, Verifique los datos..!');
						  </script>";
				}
				if ($idcaso==-1)
				{
					echo "<script language='JavaScript'> 
							alert('Han Ocurrido Errores al Intentar Registrar el Solicitante o el Beneficiario... Verificar los datos');
						  </script>";
				}	
			}
        ...
        <center>
            <form name="frmcaso" id="frmcaso" method="post" action='frm_casos_nuevos.php'>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td width="65%" class="menu_izq_titulo"><img src="../comunes/imagenes/folder_add.png" />
							Registrar Caso
                        </td>
					...
					<td colspan="2">
                          <table width="100%" border="1" class="tablaTitulo" >					
							...
							<tr>
                                <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                    <div align="center" style="background-image: url('../comunes/imagenes/barra.png');">
                                    <strong>Datos del Beneficiario</strong></div>
                                </td>
                            </tr>
