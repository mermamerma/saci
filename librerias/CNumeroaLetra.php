 ...
 ***************************************************************************/
	...
	//5 => array ('MIL ','MILLON ','MILLONES ','CERO ','Y ','UN ','UN MIL ','UNO ','DOS ','CON ','','')
	);
	private $aTexto;
			...
			for ($pos=0; $pos<12; $pos++){
   			...
   			if ($this->noMoneda){
	   			...
	   			if($this->mayusculas){//mayusculas
					...
					#$texto=strtoupper($this->prefijo.$texto." ".$this->moneda." CON ".substr($cnumero,-2)." ".$this->sufijo);	
					//$texto=strtoupper($this->prefijo.$texto." ".$this->moneda." CON ");
					$texto=strtoupper($this->moneda." ".$this->prefijo.$texto." CON ");
				}else{//minusculas
					//$texto=strtolower($this->prefijo.$texto." ".$this->moneda." con ".substr($cnumero,-2)."/100 ".$this->sufijo);
					$texto=strtolower($this->prefijo.$texto." ".$this->moneda);	
				}
   			}
