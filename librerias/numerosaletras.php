...
*/
		...
		*/
				...
				'siete','ocho','nueve','diez','once','doce','trece','catorce',
				'quince','dieciseis','diecisiete','dieciocho','diecinueve','veinte','veintiuno','veintidos','ventitres',
		...
		*/
		function unidades($unidad){
				$valores = array('cero','un','dos','tres','cuatro','cinco','seis','siete','ocho','nueve',
				'diez','once','doce','trece','catorce','quince','dieciseis','diecisiete','dieciocho','diecinueve',
				'veinte','veintiuno','veintidos','ventitres','veinticuatro','veinticinco','veintiseis','veintisiete','veintiocho','veintinueve',
				30=>'treinta',40=>'cuarenta',50=>'cincuenta',
				60=>'sesenta',70=>'setenta',80=>'ochenta',90=>'noventa',100=>'ciento',
				101=>'quinientos',102=>'setecientos',103=>'novecientos'
				);
					...
					//echo "VALOR COMPLETO: $valor<br>";
						...
						if(($valor<100) and ($valor>9)){
								if($valor<30){
										...
										$letras.=$tempo;
										$Numer =round($valor-Intval($valor),2);
									}else{
		...
		*/
		function convertir($valor){
				...
				$decimales = substr($decimales,strpos($decimales,'.'),2)*(100);
				//$decimales = substr($decimales,strpos($decimales,'.'),2);
				$decimales= $decimales;  /////////////////////////////////// REDONDEO
		   //echo "TT: $tt<br>";
		   //echo "VALOR: $valor<br>";
