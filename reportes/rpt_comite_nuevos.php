...
$pdf->setY(40);
$pdf->writeHTML('<span style="text-align:center;"> <b>PUNTO DE CUENTA PARA EL CIUDADANO SECRETARIO GENERAL EJECUTIVO</b></span>', true, 0, true, true);
...
$pdf->setY(50);
	...
	$mensaje3 = '<span style="text-align:justify;">4)<b> &nbsp; Soluciones Propuestas al Ciudadano Secretario General Ejecutivo:</b> 
				 Se somete a la consideración del Ciudadano Secretario General Ejecutivo del Ministerio del Poder Popular para Relaciones Exteriores, 
				...
				de fecha '.$fecha_gaceta.', autorizar la cantidad de <b> '.$monto.' (Bs.),</b> a favor de <b>'.$razon_social.', RIF.: '.$rif.',</b>  '.$concepto.'  </span>';
...
<tr>
	 <td style="text-align:center; color: #000000;	font-weight: bold;	background-color:#999999 ;font-size:xx-large;">  $descripcion </td>
</tr>
...
$pdf->MultiCell(130, 40, $nombre_secretario.'                                                                       '.$cargo_secretario,1, 'C',0, 0, '', '', true, 0, false, true, 40, 'M');
	 
$pdf->setY(133);
$pdf->MultiCell(50, 40, 'REVISADO POR: ', 1, 'C',0, 0, '', '', true, 0, false, true, 40, 'M');
$pdf->MultiCell(130, 40, $nombre_dir_ac.'                                                                           '.$cargo_dir_ac,1, 'C',0, 0, '', '', true, 0, false, true, 40, 'M');
	 
$pdf->setY(173);
$pdf->MultiCell(50, 40, 'ELABORADO POR: ', 1, 'C',0, 0, '', '', true, 0, false, true, 40, 'M');
$pdf->MultiCell(130, 40, $firma,1, 'C',0, 0, '', '', true, 0, false, true, 40, 'M');
...
$pdf->MultiCell(130, 40, 'PUNTO DE CUENTA AL CIUDADANO SECRETARIO GENERAL EJECUTIVO', 1, 'C',0, 0, '', '', true, 0, false, true, 40, 'M');
$pdf->setY(80);
$pdf->MultiCell(50, 40, 'ASUNTO ', 1, 'C',0, 0, '', '', true, 0, false, true, 40, 'M');
$pdf->MultiCell(130, 40,$argumentacion, 1, 'C',0, 0, '', '', true, 0, false, true, 40, 'M');
$pdf->setY(120);
