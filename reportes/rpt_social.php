...
class MYPDF extends TCPDF
{
	// Page footer
        ...
        public function  Footer()
        {
            ...
            $this->Cell(0, 10, "SACI - Sistema de Atención al Ciudadano, Generado el:  (".fechaactual()."). Licencia: GPL/GNU. Creado por ".$this->author.".   Página ".$this->getAliasNumPage()."/".$this->getAliasNbPages(), 0, 0, 'C');
...
<tr>
<td><b>Nacionalidad:</b><br>".$nacionalidad."</td>
<td><b>Ocupación:</b><br>".$ocupacion."</td>
<td><b>Estado Civil:</b><br>".$civil."</td>
</tr>
...
<tr>
<td><b>Estado:</b><br>".ucfirst(strtolower($estado))."</td>
<td><b>Municipio:</b><br>".ucfirst(strtolower($municipio))."</td>
<td><b>Parroquia:</b><br>".ucfirst(strtolower($parroquia))."</td>
</tr>
...
{
    $data_mision=split(",", $rs_misiones_selec->rowset["misiones"]);
}
...
<tr>
<td colspan=\"2\"><b>Tipo de Vivienda donde habita actualmente:</b><br>".$tipo_vivienda."</td>
<td><b>Tenencia de la Vivienda:</b><br>".$tenencia_vivienda."</td>
</tr>
</table>
...
{
    $data_mision=split(",", $rs_servicios_selec->rowset["servicios_publicos"]);
}
...
$strSql="select razon_social, cedula, edad, sparentesco, sgrado_instruccion as sgrado, socupacion, ingreso_mensual from vsolicitantes where idsolicitante=".$idsolicitante."
         union
         select razon_social, cedula, edad, sparentesco, sgrado, socupacion, ingreso_mensual from vnucleo_familiar where idsolicitante=".$idsolicitante." order by edad";
...
while($rs_perfil->Mostrar())
{
    $tabla.="<tr>
                ...
                <td align=\"center\"><b>".$rs_perfil->rowset["sparentesco"]."</b></td>
                <td align=\"center\">".$rs_perfil->rowset["sgrado"]."</td>
                <td align=\"center\">".$rs_perfil->rowset["socupacion"]."</td>
