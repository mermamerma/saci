	...
	class ccasos extends Datos
{
    ...
    function insertar_caso($formulario)
    {
        ...
        $sentencia_sql="Insert Into casos_actuales (idsolicitante,idbeneficiario,fecha_registro,idremitente,idtipocaso,idestado,idmunicipio,idparroquia,descripcion_caso,idusuario, idestatus, 
